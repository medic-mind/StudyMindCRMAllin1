...
-- 3. Insert the user's preferred columns where they don't already exist.
-- Idempotent on the stable seed ids so re-running the migration is safe.
...
-- 4. Reposition existing seeded stages so the order matches the user's
-- columns. "Never answered" sits at 7, "Call completed" at 8.
