...
export type { AuditTarget, WriteAuditLogEntryInput, DbClient, WithAuditCtx, AuditingTx } from './writer'
export { writeAuditLogEntry, withAudit } from './writer'
export { jsonDiff } from './diff'
export type { JsonDiffEntry } from './diff'
...
export type AuditLogInput = Omit<
  import('./writer').WriteAuditLogEntryInput,
  'actorId' | 'requestId'
>
