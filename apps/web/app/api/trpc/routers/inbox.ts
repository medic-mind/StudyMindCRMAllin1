      ...
      .query(async ({ ctx, input }) => {
        ...
        return {
          head: {
            ...
            isTrashed: head.isTrashed,
            // Gmail-parity toolbar state (spam / important toggles).
            isImportant: head.gmailLabelIds.includes('IMPORTANT'),
            isSpam: head.gmailLabelIds.includes('SPAM'),
