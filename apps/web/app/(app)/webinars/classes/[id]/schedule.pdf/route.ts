// Serve a class's schedule PDF — the uploaded syllabus if one exists, else the
// generated term schedule. Same artefact that the weekly email attaches, so
// staff can preview exactly what families receive.
