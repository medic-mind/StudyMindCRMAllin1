...
| Company knowledge Q&A (AI Knowledge, ADR 0040) | gpt-4o (standard) | Grounded on the FULL imported Crib knowledge base (~90k input tokens/call); quotes prices/dates verbatim, refuses outside it |
